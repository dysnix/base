...
- Registrar submits `registerTDXSigner(output, proofBytes)`.
...
- RISC Zero verifier configuration.
...
- The deployed registry is wired to the intended RISC Zero `TDXVerifier` configuration.
